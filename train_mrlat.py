...
import numpy as np
import wandb
from models.mrlat import Config, Model, Collator
from dataset_pH import DatasetPhClassification
...
def parse_args():
    ...
    parser.add_argument('--config', type=str, required=False, default='configs/mrlat.yaml', help='Path to the YAML config file')
...
if __name__ == '__main__':
    ...
    dataset_train = DatasetPhClassification(config['dataset']['train'])
    dataset_val = DatasetPhClassification(config['dataset']['val'])
    dataset_test = DatasetPhClassification(config['dataset']['test'])
